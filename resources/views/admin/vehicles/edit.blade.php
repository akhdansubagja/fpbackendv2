            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" id="merk" name="merk" class="form-control" required value="{{ old('merk', $vehicle->merk) }}">
                    </div>
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama/Model Kendaraan</label>
                        <input type="text" id="nama" name="nama" class="form-control" required value="{{ old('nama', $vehicle->nama) }}">
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="harga_sewa_harian" class="form-label">Harga Sewa / Hari</label>
                            <input type="number" id="harga_sewa_harian" name="harga_sewa_harian" class="form-control" required value="{{ old('harga_sewa_harian', $vehicle->harga_sewa_harian) }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="jumlah_kursi" class="form-label">Jumlah Kursi</label>
                            <input type="number" id="jumlah_kursi" name="jumlah_kursi" class="form-control" required value="{{ old('jumlah_kursi', $vehicle->jumlah_kursi) }}">
                        </div>
                    </div>
                     <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                         ...
                         <div class="col-md-4 mb-3">
                            ...
                            <select id="has_ac" name="has_ac" class="form-select" required>
                                <option value="1" {{ old('has_ac', $vehicle->has_ac) ? 'selected' : '' }}>Ada AC</option>
                                <option value="0" {{ !old('has_ac', $vehicle->has_ac) ? 'selected' : '' }}>Tidak Ada AC</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="deskripsi" class="form-label">Deskripsi</label>
                        <textarea id="deskripsi" name="deskripsi" rows="4" class="form-control" required>{{ old('deskripsi', $vehicle->deskripsi) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
